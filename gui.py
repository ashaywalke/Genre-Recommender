...
print "Rate the following Movies on a scale of 1 to 5:"
...
print "Following are the Users with the same preferences."
...
print "Following are the Movie Genre you would like:"
